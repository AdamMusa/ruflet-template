...
class RufletMockBackendChannel implements RufletBackendChannel {
  ...
  Future connect() async {
    ...
    debugPrint("Connected to the Mock Ruflet backend channel");
  ...
  @override
  void disconnect() {
    debugPrint("Disconnected from the Mock Ruflet backend channel");
  }
}
