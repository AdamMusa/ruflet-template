...
class RufletSocketBackendChannel implements RufletBackendChannel {
  String address;
  ...
  RufletSocketBackendChannel({
    required this.address,
    required this.onDisconnect,
    required this.onMessage,
  }) : _streamingDeserializer =
            StreamingMsgpackDeserializer(extDecoder: RufletMsgpackDecoder());
