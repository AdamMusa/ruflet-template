...
class Control extends ChangeNotifier {
  ...
  late final WeakReference<RufletBackend> _backend;
  ...
  Control({
    ...
    required RufletBackend backend,
    Control? parent,
  }) {
    if (parent != null) {
  ...
  RufletBackend get backend => _backend.target!;
  ...
  factory Control.fromMap(Map<dynamic, dynamic> data, RufletBackend backend,
      {Control? parent}) {
  ...
  void applyPatch(List<dynamic> patch, RufletBackend backend,
  ...
  static dynamic _transformIfControl(
      dynamic value, Control? parent, RufletBackend backend) {
