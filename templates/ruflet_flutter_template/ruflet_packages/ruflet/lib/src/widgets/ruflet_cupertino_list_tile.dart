...
// found in ../utils/FLUTTER_LICENSE.

// Forked from Flutter RufletCupertinoListTile. The label column shrink-wraps so
// an explicit Ruby row height centers labels instead of stretching them.
library;
...
enum _RufletCupertinoListTileType { base, notched }

/// An iOS-style list tile.
///
/// The [RufletCupertinoListTile] is a Cupertino equivalent of Material [ListTile].
...
/// the latter using named constructor [RufletCupertinoListTile.notched].
///
...
///    [RufletCupertinoListTile].
///  * [ListTile], a Material Design list tile.
class RufletCupertinoListTile extends StatefulWidget {
  ...
  ///
  /// The [trailing] parameter is typically a [RufletCupertinoListTileChevron], an
  ...
  /// [RufletCupertinoListTile]. For native look, it should not be provided.
  ///
  ...
  /// type of [RufletCupertinoListTile]. For native look, it should not be provided.
  ///
  ...
  /// look, depending on a type of [RufletCupertinoListTile]. For native look, it
  /// should not be provided.
  const RufletCupertinoListTile({
    super.key,
    required this.title,
    this.subtitle,
    this.additionalInfo,
  ...
  }) : _type = _RufletCupertinoListTileType.base;
  ...
  /// look, depending on a type of [RufletCupertinoListTile]. For native look, it
  /// should not be provided.
  const RufletCupertinoListTile.notched({
    super.key,
    required this.title,
    this.subtitle,
    this.additionalInfo,
  ...
  }) : _type = _RufletCupertinoListTileType.notched;

  final _RufletCupertinoListTileType _type;
  ...
  /// A widget displayed at the start of the [RufletCupertinoListTile]. This is
  /// typically an `Icon` or an `Image`.
  final Widget? leading;

  /// A widget displayed at the end of the [RufletCupertinoListTile]. This is usually
  /// a right chevron icon (e.g. `RufletCupertinoListTileChevron`), or an `Icon`.
  final Widget? trailing;

  /// The [onTap] function is called when a user taps on [RufletCupertinoListTile]. If
  /// left `null`, the [RufletCupertinoListTile] will not react on taps. If this is a
  /// `Future<void> Function()`, then the [RufletCupertinoListTile] remains activated
  ...
  /// Padding of the content inside [RufletCupertinoListTile].
  ...
  @override
  State<RufletCupertinoListTile> createState() =>
      _RufletCupertinoListTileState();
}

class _RufletCupertinoListTileState extends State<RufletCupertinoListTile> {
  bool _tapped = false;
  ...
  Widget build(BuildContext context) {
    ...
    final bool baseType = switch (widget._type) {
      _RufletCupertinoListTileType.base => true,
      _RufletCupertinoListTileType.notched => false,
    };
    ...
    final EdgeInsetsGeometry padding = widget.padding ??
        switch (widget._type) {
          _RufletCupertinoListTileType.base when widget.subtitle != null =>
            _kPaddingWithSubtitle,
          _RufletCupertinoListTileType.notched when widget.leading != null =>
            _kNotchedPadding,
          _RufletCupertinoListTileType.base => _kPadding,
          _RufletCupertinoListTileType.notched =>
    ...
    final double minHeight = switch (widget._type) {
      ...
      _RufletCupertinoListTileType.notched when widget.leading != null =>
        _kNotchedMinHeight,
      _RufletCupertinoListTileType.base => _kMinHeight,
      _RufletCupertinoListTileType.notched => _kNotchedMinHeightWithoutLeading,
    };
          ...
          child: Row(
            children: <Widget>[
              ...
              if (widget.additionalInfo
                ...
                DefaultTextStyle(
                    style: coloredStyle, maxLines: 1, child: additionalInfo),
...
/// A typical iOS trailing widget used to denote that a `RufletCupertinoListTile` is a
/// button with an action.
///
/// The [RufletCupertinoListTileChevron] is meant as a convenience implementation of
/// trailing right chevron.
class RufletCupertinoListTileChevron extends StatelessWidget {
  /// Creates a typical widget used to denote that a `RufletCupertinoListTile` is a
  /// button with action.
  const RufletCupertinoListTileChevron({super.key});
