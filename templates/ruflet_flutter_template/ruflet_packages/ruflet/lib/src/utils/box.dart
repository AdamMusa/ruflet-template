...
List<BoxShadow>? parseBoxShadows(dynamic value, RufletStyleTheme theme,
...
BoxShadow? parseBoxShadow(dynamic value, RufletStyleTheme theme,
    [BoxShadow? defaultValue]) {
  if (value == null) return defaultValue;

  return BoxShadow(
      color: parseColor(value["color"], theme, RufletColors.black)!,
...
BoxDecoration? parseBoxDecoration(dynamic value, BuildContext context,
  ...
  if (value == null) return defaultValue;
  var theme = RufletStyleTheme.of(context);
...
DecorationImage? parseDecorationImage(dynamic value, BuildContext context,
  ...
  return DecorationImage(
    image: image,
    colorFilter:
        parseColorFilter(value["color_filter"], RufletStyleTheme.of(context)),
...
extension BoxParsers on Control {
  ...
  List<BoxShadow>? getBoxShadows(String propertyName, RufletStyleTheme theme,
      [List<BoxShadow>? defaultValue]) {
