...
Gradient? parseGradient(dynamic value, RufletStyleTheme theme,
...
List<Color> parseColors(dynamic value, RufletStyleTheme? theme) {
...
extension GradientParsers on Control {
  Gradient? getGradient(String propertyName, RufletStyleTheme theme) {
    return parseGradient(get(propertyName), theme);
  }

  List<Color> getColors(String propertyName, RufletStyleTheme theme) {
