...
TextStyle? parseTextThemeStyle(String? styleName, BuildContext context) =>
    styleName == null ? null : RufletStyleTheme.of(context).textStyle(styleName);
...
List<TextSpan> parseTextSpans(List<Control> spans, RufletStyleTheme theme,
...
TextSpan? parseInlineSpan(Control span, RufletStyleTheme theme,
    [void Function(Control, String, [dynamic eventData])? sendControlEvent]) {
...
TextStyle? parseTextStyle(dynamic value, RufletStyleTheme theme,
...
extension TextParsers on Control {
  TextStyle? getTextStyle(String propertyName, RufletStyleTheme theme,
      [TextStyle? defaultValue]) {
