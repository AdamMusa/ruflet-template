...
Border? parseBorder(dynamic value, RufletStyleTheme? theme,
    {Color defaultSideColor = RufletColors.black,
...
BorderSide? parseBorderSide(dynamic value, RufletStyleTheme? theme,
    {Color defaultSideColor = RufletColors.black, BorderSide? defaultValue}) {
  if (value == null) return defaultValue;
  return BorderSide(
...
ShapeBorder? parseShapeBorder(dynamic value, RufletStyleTheme? theme,
...
OutlinedBorder? parseOutlinedBorder(dynamic value, RufletStyleTheme? theme,
...
OutlinedBorder? parseShape(dynamic value, RufletStyleTheme? theme,
    {BorderSide defaultBorderSide = BorderSide.none,
    BorderRadius defaultBorderRadius = BorderRadius.zero,
    OutlinedBorder? defaultValue}) {
  return parseOutlinedBorder(value, theme,
...
extension BorderParsers on Control {
  ...
  Border? getBorder(String propertyName, RufletStyleTheme theme,
      {Color defaultSideColor = RufletColors.black,
      BorderSide? defaultBorderSide,
      Border? defaultValue}) {
  ...
  BorderSide? getBorderSide(String propertyName, RufletStyleTheme theme,
      {Color defaultSideColor = RufletColors.black, BorderSide? defaultValue}) {
    return parseBorderSide(get(propertyName), theme,
        defaultSideColor: defaultSideColor, defaultValue: defaultValue);
  }

  OutlinedBorder? getOutlinedBorder(String propertyName, RufletStyleTheme? theme,
      {BorderSide defaultBorderSide = BorderSide.none,
      BorderRadius defaultBorderRadius = BorderRadius.zero,
      OutlinedBorder? defaultValue}) {
  ...
  OutlinedBorder? getShape(String propertyName, RufletStyleTheme? theme,
      {BorderSide defaultBorderSide = BorderSide.none,
      BorderRadius defaultBorderRadius = BorderRadius.zero,
      OutlinedBorder? defaultValue}) {
    return parseOutlinedBorder(get(propertyName), theme,
