...
Paint? parsePaint(dynamic value, RufletStyleTheme theme, [Paint? defaultValue]) {
  if (value == null) return defaultValue;

  var paint = Paint();
  paint.color = parseColor(value["color"] as String?, theme, RufletColors.black)!;
...
ui.Gradient? parsePaintGradient(
    Map<dynamic, dynamic>? value, RufletStyleTheme? theme,
...
extension DrawingParsers on Control {
  Paint? getPaint(String propertyName, RufletStyleTheme theme,
      [Paint? defaultValue]) {
