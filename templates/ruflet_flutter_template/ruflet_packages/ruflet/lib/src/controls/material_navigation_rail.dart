...
class MaterialNavigationRailControl extends StatefulWidget {
  final Control control;

  MaterialNavigationRailControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialNavigationRailControl> createState() =>
      _NavigationRailControlState();
}

class _NavigationRailControlState extends State<MaterialNavigationRailControl>
