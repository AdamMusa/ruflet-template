...
class MaterialRangeSliderControl extends StatefulWidget {
  final Control control;

  MaterialRangeSliderControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialRangeSliderControl> createState() => _SliderControlState();
}

class _SliderControlState extends State<MaterialRangeSliderControl> {
  @override
  void initState() {
    super.initState();
  }
