...
class MaterialChipControl extends StatefulWidget {
  final Control control;

  MaterialChipControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialChipControl> createState() => _ChipControlState();
}

class _ChipControlState extends State<MaterialChipControl> {
