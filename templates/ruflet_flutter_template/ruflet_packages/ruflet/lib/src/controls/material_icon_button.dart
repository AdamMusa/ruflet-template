...
class MaterialIconButtonControl extends StatefulWidget {
  final Control control;

  MaterialIconButtonControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialIconButtonControl> createState() => _IconButtonControlState();
}

class _IconButtonControlState extends State<MaterialIconButtonControl> {
  ...
  Widget build(BuildContext context) {
    ...
    var sizeConstraints = widget.control.getBoxConstraints("size_constraints");
    ...
    Function(bool)? onHoverHandler = !widget.control.disabled
        ? (bool hovered) => RufletBackend.of(context)
