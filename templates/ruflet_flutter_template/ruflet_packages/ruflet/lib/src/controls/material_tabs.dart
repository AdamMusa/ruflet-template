...
class MaterialTabsControl extends StatefulWidget {
  final Control control;

  MaterialTabsControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialTabsControl> createState() => _TabsControlState();
}

class _TabsControlState extends State<MaterialTabsControl>
  ...
  @override
  void didUpdateWidget(MaterialTabsControl oldWidget) {
...
class MaterialTabBarViewControl extends StatelessWidget {
  final Control control;

  const MaterialTabBarViewControl({super.key, required this.control});
...
class MaterialTabControl extends Tab {
  final Control control;

  MaterialTabControl({super.key, required this.control})
      : super(
          ...
          // In Ruflet, the real content is built from `control` in `build()`,
...
class MaterialTabBarControl extends StatefulWidget {
  final Control control;

  const MaterialTabBarControl({super.key, required this.control});

  @override
  State<MaterialTabBarControl> createState() => _TabBarControlState();
}

class _TabBarControlState extends State<MaterialTabBarControl> {
  @override
  Widget build(BuildContext context) {
    ...
    if (tabsState != null) {
      ...
      final tabs = widget.control.children("tabs").map((tab) {
        ...
        if (tab.type == "Tab") {
          return MaterialTabControl(control: tab);
        }
