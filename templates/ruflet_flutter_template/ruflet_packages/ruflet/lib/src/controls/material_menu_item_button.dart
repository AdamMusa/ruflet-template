...
class MaterialMenuItemButtonControl extends StatefulWidget {
  final Control control;

  MaterialMenuItemButtonControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialMenuItemButtonControl> createState() =>
      _MenuItemButtonControlState();
}

class _MenuItemButtonControlState extends State<MaterialMenuItemButtonControl> {
