  ...
  Future<dynamic> _invokeMethod(String name, dynamic args) async {
    ...
    switch (name) {
      case "capture":
        ...
        final painter = RufletCustomPainter(
            context: context,
            theme: RufletStyleTheme.of(context),
            shapes: shapes,
...
class RufletCustomPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(RufletCustomPainter oldPainter) {
    return true;
  }
