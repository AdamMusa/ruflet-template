...
class MaterialNavigationDrawerControl extends StatefulWidget {
  final Control control;

  MaterialNavigationDrawerControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialNavigationDrawerControl> createState() =>
      _NavigationDrawerControlState();
}

class _NavigationDrawerControlState
    extends State<MaterialNavigationDrawerControl> {
