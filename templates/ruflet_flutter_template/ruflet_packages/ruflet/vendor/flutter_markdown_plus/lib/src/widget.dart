...
abstract class MarkdownWidget extends StatefulWidget {
  ...
  /// Native selection toolbar override for Cupertino display text.
  /// The editable-text contextMenuBuilder remains available on Material.
...
class _MarkdownWidgetState extends State<MarkdownWidget> implements MarkdownBuilderDelegate {
  ...
  void _parseMarkdown() {
    ...
    final MarkdownBuilder builder = MarkdownBuilder(
      ...
      useCupertino: widget.styleSheetTheme == MarkdownStyleSheetBaseTheme.cupertino ||
          (widget.styleSheetTheme == MarkdownStyleSheetBaseTheme.platform && kIsCupertinoPlatform),
      cupertinoContextMenuBuilder: widget.cupertinoContextMenuBuilder,
...
class MarkdownBody extends MarkdownWidget {
  ...
  const MarkdownBody({
    ...
    required super.data,
    super.selectable,
    super.cupertinoContextMenuBuilder,
    super.styleSheet,
