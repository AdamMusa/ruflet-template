...
class MaterialBlockPickerControl extends StatefulWidget {
  final Control control;

  const MaterialBlockPickerControl({super.key, required this.control});

  @override
  State<MaterialBlockPickerControl> createState() =>
      _MaterialBlockPickerControlState();
}

class _MaterialBlockPickerControlState
    extends State<MaterialBlockPickerControl> {
  ...
  Widget build(BuildContext context) {
    debugPrint("MaterialBlockPickerControl build: ${widget.control.id}");
