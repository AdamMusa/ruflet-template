...
class HSVWithHueColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const Gradient gradientV = LinearGradient(
      ...
      colors: [PaletteColors.white, PaletteColors.black],
    );
...
class HSVWithSaturationColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const Gradient gradientV = LinearGradient(
      ...
      colors: [PaletteColors.transparent, PaletteColors.black],
    );
...
class HSVWithValueColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const Gradient gradientV = LinearGradient(
      ...
      colors: [PaletteColors.transparent, PaletteColors.white],
    );
    final List<Color> colors = [
    ...
    canvas.drawRect(
      rect,
      Paint()..color = PaletteColors.black.withOpacity(1 - hsvColor.value),
    );
...
class TrackPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (trackType == TrackType.alpha) {
      ...
      Paint chessPaintW = Paint()..color = PaletteColors.white;
...
class IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint chessPaintW = Paint()..color = PaletteColors.white;
    List.generate((size.height / chessSize.height).round(), (int y) {
      List.generate((size.width / chessSize.width).round(), (int x) {
        canvas.drawRect(
      ...
      CupertinoButton(
        ...
        onPressed: () => showCupertinoModalPopup<void>(
          ...
          builder: (context) => CupertinoActionSheet(
            actions: [
              for (final type in widget.colorLabelTypes)
        ...
        child: Text(_colorType.name.toUpperCase()),
      ),
    ...
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        if (!widget.embeddedText)
          Text('Hex', style: CupertinoTheme.of(context).textTheme.textStyle),
        const SizedBox(width: 10),
        SizedBox(
          width:
              (CupertinoTheme.of(context).textTheme.textStyle.fontSize ?? 14) *
                  10,
          child: CupertinoTextField(
            ...
            placeholder: widget.embeddedText ? 'Hex' : null,
