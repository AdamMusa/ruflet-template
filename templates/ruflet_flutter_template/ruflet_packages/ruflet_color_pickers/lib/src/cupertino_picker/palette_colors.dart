...
class PaletteColor extends ColorSwatch<int> {
...
class PaletteAccentColor extends ColorSwatch<int> {
  const PaletteAccentColor(super.primary, super.swatch);
...
abstract final class PaletteColors {
  ...
  static const PaletteColor red = PaletteColor(_redPrimaryValue, <int, Color>{
    50: Color(0xFFFFEBEE),
  ...
  static const PaletteAccentColor redAccent =
      PaletteAccentColor(_redAccentValue, <int, Color>{
  ...
  static const PaletteColor pink = PaletteColor(_pinkPrimaryValue, <int, Color>{
    50: Color(0xFFFCE4EC),
  ...
  static const PaletteAccentColor pinkAccent =
      PaletteAccentColor(_pinkAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor purple =
      PaletteColor(_purplePrimaryValue, <int, Color>{
    50: Color(0xFFF3E5F5),
  ...
  static const PaletteAccentColor purpleAccent =
      PaletteAccentColor(_purpleAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor deepPurple =
      PaletteColor(_deepPurplePrimaryValue, <int, Color>{
    50: Color(0xFFEDE7F6),
  ...
  static const PaletteAccentColor deepPurpleAccent =
      PaletteAccentColor(_deepPurpleAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor indigo =
      PaletteColor(_indigoPrimaryValue, <int, Color>{
    50: Color(0xFFE8EAF6),
  ...
  static const PaletteAccentColor indigoAccent =
      PaletteAccentColor(_indigoAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor blue = PaletteColor(_bluePrimaryValue, <int, Color>{
    50: Color(0xFFE3F2FD),
  ...
  static const PaletteAccentColor blueAccent =
      PaletteAccentColor(_blueAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor lightBlue =
      PaletteColor(_lightBluePrimaryValue, <int, Color>{
    50: Color(0xFFE1F5FE),
  ...
  static const PaletteAccentColor lightBlueAccent =
      PaletteAccentColor(_lightBlueAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor cyan = PaletteColor(_cyanPrimaryValue, <int, Color>{
    50: Color(0xFFE0F7FA),
  ...
  static const PaletteAccentColor cyanAccent =
      PaletteAccentColor(_cyanAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor teal = PaletteColor(_tealPrimaryValue, <int, Color>{
    50: Color(0xFFE0F2F1),
  ...
  static const PaletteAccentColor tealAccent =
      PaletteAccentColor(_tealAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor green =
      PaletteColor(_greenPrimaryValue, <int, Color>{
    50: Color(0xFFE8F5E9),
  ...
  static const PaletteAccentColor greenAccent =
      PaletteAccentColor(_greenAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor lightGreen =
      PaletteColor(_lightGreenPrimaryValue, <int, Color>{
    50: Color(0xFFF1F8E9),
  ...
  static const PaletteAccentColor lightGreenAccent =
      PaletteAccentColor(_lightGreenAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor lime = PaletteColor(_limePrimaryValue, <int, Color>{
    50: Color(0xFFF9FBE7),
  ...
  static const PaletteAccentColor limeAccent =
      PaletteAccentColor(_limeAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor yellow =
      PaletteColor(_yellowPrimaryValue, <int, Color>{
    50: Color(0xFFFFFDE7),
  ...
  static const PaletteAccentColor yellowAccent =
      PaletteAccentColor(_yellowAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor amber =
      PaletteColor(_amberPrimaryValue, <int, Color>{
    50: Color(0xFFFFF8E1),
  ...
  static const PaletteAccentColor amberAccent =
      PaletteAccentColor(_amberAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor orange =
      PaletteColor(_orangePrimaryValue, <int, Color>{
    50: Color(0xFFFFF3E0),
  ...
  static const PaletteAccentColor orangeAccent =
      PaletteAccentColor(_orangeAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor deepOrange =
      PaletteColor(_deepOrangePrimaryValue, <int, Color>{
    50: Color(0xFFFBE9E7),
  ...
  static const PaletteAccentColor deepOrangeAccent =
      PaletteAccentColor(_deepOrangeAccentPrimaryValue, <int, Color>{
  ...
  static const PaletteColor brown =
      PaletteColor(_brownPrimaryValue, <int, Color>{
    50: Color(0xFFEFEBE9),
  ...
  static const PaletteColor grey = PaletteColor(_greyPrimaryValue, <int, Color>{
    50: Color(0xFFFAFAFA),
  ...
  static const PaletteColor blueGrey =
      PaletteColor(_blueGreyPrimaryValue, <int, Color>{
    50: Color(0xFFECEFF1),
  ...
  static const List<PaletteColor> primaries = <PaletteColor>[
    red,
    pink,
    purple,
    deepPurple,
  ...
  static const List<PaletteAccentColor> accents = <PaletteAccentColor>[
    redAccent,
    pinkAccent,
    purpleAccent,
    deepPurpleAccent,
