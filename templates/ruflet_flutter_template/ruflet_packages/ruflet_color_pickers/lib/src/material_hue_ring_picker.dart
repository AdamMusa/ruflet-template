...
class MaterialHueRingPickerControl extends StatefulWidget {
  final Control control;

  const MaterialHueRingPickerControl({super.key, required this.control});

  @override
  State<MaterialHueRingPickerControl> createState() =>
      _MaterialHueRingPickerControlState();
}

class _MaterialHueRingPickerControlState
    extends State<MaterialHueRingPickerControl> {
  ...
  Widget build(BuildContext context) {
    debugPrint("MaterialHueRingPickerControl build: ${widget.control.id}");
