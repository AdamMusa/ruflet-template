...
The first-party Ruflet QR and barcode scanner extension. It is a standard Ruflet
Flutter extension: the public library exports `Extension`, `Extension` extends
`RufletExtension`, and `createWidget()` handles the `qrcode_scanner` control type.
