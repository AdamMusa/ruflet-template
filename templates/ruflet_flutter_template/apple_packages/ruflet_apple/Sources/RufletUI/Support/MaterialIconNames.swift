// Generated by tools/generate_apple_icon_table.rb -- do not edit by hand.
//
// Ruflet serializes icons as an index into the gem's icons.json rather than a
// font codepoint, so recovering the name is a lookup into the same ordering.
...
enum MaterialIconNames {
  ...
  /// Material icon names in codepoint order, starting at `firstCodepoint`.
  static let material: [String] = materialTable.split(separator: "\n").map(String.init)

  /// Cupertino icon names in codepoint order, starting at `cupertinoFirstCodepoint`.
...
"""
  ...
  private static let cupertinoTable = """
ADD
ADD_CIRCLED
ADD_CIRCLED_SOLID
AIRPLANE
