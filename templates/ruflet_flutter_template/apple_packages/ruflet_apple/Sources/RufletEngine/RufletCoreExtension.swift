...
public struct RufletCoreExtension: RufletExtension {
  ...
  public let renderedControlTypes: Set<String> = [
    ...
    "CupertinoAlertDialog", "CupertinoAppBar", "CupertinoBottomSheet", "CupertinoContextMenu",
    "CupertinoContextMenuAction", "CupertinoDatePicker", "CupertinoListTile", "CupertinoPicker",
    "CupertinoRadio", "CupertinoSegmentedButton", "CupertinoSlider",
    "CupertinoSlidingSegmentedButton", "CupertinoSwitch", "CupertinoTextField",
    "CupertinoTimerPicker", "CupertinoTintedButton", "Dismissible",
    "DataTable", "DatePicker", "DateRangePicker", "Divider", "Draggable", "DragTarget", "Dropdown",
    "DropdownM2", "ExpansionPanelList", "ExpansionTile", "FilledButton", "FilledIconButton",
    "FilledTonalButton", "FilledTonalIconButton", "FloatingActionButton", "GestureDetector",
    "GridView", "Hero",
    "CupertinoNavigationBar", "FletApp", "RufletApp", "Icon", "IconButton", "Image",
    "InteractiveViewer", "KeyboardListener", "ListTile", "ListView", "Markdown", "MenuBar",
    "MenuItemButton", "MergeSemantics", "NavigationBar", "NavigationBarDestination",
  ...
  public func createView(for control: RufletControl) -> AnyView? {
    ...
    case "AdaptiveButton", "Button", "FilledButton", "FilledTonalButton", "OutlinedButton",
      "TextButton":
    ...
    case "CupertinoActionSheetAction":
      return AnyView(CupertinoActionSheetActionControl(control: control))
    case "CupertinoActivityIndicator":
      return AnyView(CupertinoActivityIndicatorControl(control: control))
    ...
    case "CupertinoContextMenuAction":
      return AnyView(CupertinoContextMenuActionControl(control: control))
    ...
    case "CupertinoSegmentedButton":
      return AnyView(CupertinoSegmentedButtonControl(control: control))
    case "CupertinoSlider": return AnyView(CupertinoSliderControl(control: control))
    case "CupertinoSlidingSegmentedButton":
      return AnyView(CupertinoSlidingSegmentedButtonControl(control: control))
    ...
    case "FletApp", "RufletApp": return AnyView(FletAppControl(control: control))
    ...
    case "NavigationBarDestination":
      return AnyView(NavigationBarDestinationControl(control: control))
