...
class _DataTable2ControlState extends State<MaterialDataTable2Control> {
  ...
  Widget build(BuildContext context) {
    ...
    var border = widget.control.getBorder("border", FletStyleTheme.of(context));
    var borderRadius = widget.control.getBorderRadius("border_radius");
    var gradient =
        widget.control.getGradient("gradient", FletStyleTheme.of(context));
    var horizontalLines = widget.control
        .getBorderSide("horizontal_lines", FletStyleTheme.of(context));
    var verticalLines = widget.control
        .getBorderSide("vertical_lines", FletStyleTheme.of(context));
    ...
    if (bgColor != null ||
      ...
      decoration = (defaultDecoration as BoxDecoration).copyWith(
          color: parseColor(bgColor, FletStyleTheme.of(context)),
          border: border,
    ...
    var datatable2 = DataTable2(
      ...
      dataRowColor: widget.control
          .getWidgetStateColor("data_row_color", FletStyleTheme.of(context)),
      ...
      dataTextStyle: widget.control
          .getTextStyle("data_text_style", FletStyleTheme.of(context)),
      headingRowColor: widget.control
          .getWidgetStateColor("heading_row_color", FletStyleTheme.of(context)),
      headingRowHeight: widget.control.getDouble("heading_row_height"),
      headingTextStyle: widget.control
          .getTextStyle("heading_text_style", FletStyleTheme.of(context)),
      ...
      rows: widget.control.children("rows").map((row) {
        ...
        return DataRow2(
          ...
          color: row.getWidgetStateColor("color", FletStyleTheme.of(context)),
