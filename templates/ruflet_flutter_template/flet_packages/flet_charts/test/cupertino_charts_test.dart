...
import 'package:flet_charts/src/candlestick_chart.dart';
import 'package:flet_charts/src/utils/charts.dart';
...
void main() {
  test('candlestick touch painter obtains outline from neutral native theme',
    ...
    final indicator = chartTouchIndicator(
        const FletStyleTheme(colors: {'outline': Color(0xFF112233)}));
