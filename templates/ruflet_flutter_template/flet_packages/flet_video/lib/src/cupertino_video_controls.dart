...
class CupertinoFletVideoControls extends StatefulWidget {
  const CupertinoFletVideoControls({super.key, required this.state});

  final VideoState state;

  @override
  State<CupertinoFletVideoControls> createState() =>
      _CupertinoFletVideoControlsState();
}

class _CupertinoFletVideoControlsState
    extends State<CupertinoFletVideoControls> {
  ...
  @override
  void didUpdateWidget(CupertinoFletVideoControls oldWidget) {
