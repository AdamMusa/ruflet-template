...
class CupertinoColorPickerControl extends StatefulWidget {
  final Control control;

  const CupertinoColorPickerControl({super.key, required this.control});

  @override
  State<CupertinoColorPickerControl> createState() =>
      _CupertinoColorPickerControlState();
}

class _CupertinoColorPickerControlState
    extends State<CupertinoColorPickerControl> {
  ...
  Widget build(BuildContext context) {
    debugPrint("CupertinoColorPickerControl build: ${widget.control.id}");
