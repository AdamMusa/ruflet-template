...
class MaterialColorPickerControl extends StatefulWidget {
  final Control control;

  const MaterialColorPickerControl({super.key, required this.control});

  @override
  State<MaterialColorPickerControl> createState() =>
      _MaterialColorPickerControlState();
}

class _MaterialColorPickerControlState
    extends State<MaterialColorPickerControl> {
  ...
  Widget build(BuildContext context) {
    debugPrint("MaterialColorPickerControl build: ${widget.control.id}");
