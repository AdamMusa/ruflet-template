...
/// Native Cupertino styling plus the additional semantic roles in Flet's DSL.
...
class FletCupertinoThemeData extends CupertinoThemeData {
  final Map<String, Color> colorOverrides;
  final Map<String, TextStyle?> textOverrides;

  FletCupertinoThemeData({
  ...
  @override
  FletCupertinoThemeData resolveFrom(BuildContext context) =>
      FletCupertinoThemeData(
  ...
  @override
  FletCupertinoThemeData copyWith({
  ...
  bool operator ==(Object other) =>
      other is FletCupertinoThemeData &&
      super == other &&
...
FletStyleTheme cupertinoStyleTheme(BuildContext context) =>
    _styleTheme(CupertinoTheme.of(context), context);

FletStyleTheme _styleTheme(CupertinoThemeData theme, BuildContext context) {
  ...
  final colors = <String, Color>{
    ...
    if (theme is FletCupertinoThemeData)
  ...
  return FletStyleTheme(
    ...
    textStyles: {
      ...
      if (theme is FletCupertinoThemeData) ...theme.textOverrides,
    },
  );
}
...
CupertinoThemeData parseCupertinoTheme(
  ...
  final colors = <String, Color>{
    if (parentTheme is FletCupertinoThemeData) ...parentTheme.colorOverrides,
  ...
  final textOverrides = <String, TextStyle?>{
    if (parentTheme is FletCupertinoThemeData) ...parentTheme.textOverrides,
    if (textMap is Map)
