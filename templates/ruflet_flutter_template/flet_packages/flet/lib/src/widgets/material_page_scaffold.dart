...
class FletMaterialPageScaffold extends StatefulWidget {
  ...
  const FletMaterialPageScaffold({
    super.key,
  ...
  @override
  State<FletMaterialPageScaffold> createState() =>
      _FletMaterialPageScaffoldState();
}

class _FletMaterialPageScaffoldState extends State<FletMaterialPageScaffold> {
  ...
  @override
  void didUpdateWidget(covariant FletMaterialPageScaffold oldWidget) {
