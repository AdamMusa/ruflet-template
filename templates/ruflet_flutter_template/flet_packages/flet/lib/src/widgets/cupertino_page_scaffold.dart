...
class FletCupertinoPageScaffold extends StatefulWidget {
  ...
  const FletCupertinoPageScaffold({
    super.key,
  ...
  @override
  State<FletCupertinoPageScaffold> createState() =>
      _FletCupertinoPageScaffoldState();
}

class _FletCupertinoPageScaffoldState extends State<FletCupertinoPageScaffold> {
  ...
  @override
  void didUpdateWidget(covariant FletCupertinoPageScaffold oldWidget) {
