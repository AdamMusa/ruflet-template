...
class MaterialSubmenuButtonControl extends StatefulWidget {
  final Control control;

  MaterialSubmenuButtonControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialSubmenuButtonControl> createState() =>
      _SubmenuButtonControlState();
}

class _SubmenuButtonControlState extends State<MaterialSubmenuButtonControl> {
