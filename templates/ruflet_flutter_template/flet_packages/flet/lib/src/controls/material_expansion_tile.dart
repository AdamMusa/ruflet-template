...
class MaterialExpansionTileControl extends StatefulWidget {
  final Control control;

  const MaterialExpansionTileControl({super.key, required this.control});

  @override
  State<MaterialExpansionTileControl> createState() =>
      _ExpansionTileControlState();
}

class _ExpansionTileControlState extends State<MaterialExpansionTileControl> {
