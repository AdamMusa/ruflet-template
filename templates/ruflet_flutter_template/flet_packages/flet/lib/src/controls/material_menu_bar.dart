...
class MaterialMenuBarControl extends StatefulWidget {
  final Control control;

  MaterialMenuBarControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialMenuBarControl> createState() => _MenuBarControlState();
}

class _MenuBarControlState extends State<MaterialMenuBarControl> {
  @override
