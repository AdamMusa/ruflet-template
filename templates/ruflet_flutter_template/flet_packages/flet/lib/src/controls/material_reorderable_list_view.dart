...
class MaterialReorderableListViewControl extends StatefulWidget {
  final Control control;

  MaterialReorderableListViewControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<MaterialReorderableListViewControl> createState() =>
      _ListViewControlState();
}

class _ListViewControlState extends State<MaterialReorderableListViewControl> {
  ...
  @override
  void didUpdateWidget(covariant MaterialReorderableListViewControl oldWidget) {
    _controls = [...widget.control.children("controls")];
