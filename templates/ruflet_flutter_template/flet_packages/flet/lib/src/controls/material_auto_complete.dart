...
class MaterialAutoCompleteControl extends StatefulWidget {
  final Control control;

  const MaterialAutoCompleteControl({super.key, required this.control});

  @override
  State<MaterialAutoCompleteControl> createState() =>
      _AutoCompleteControlState();
}

class _AutoCompleteControlState extends State<MaterialAutoCompleteControl> {
