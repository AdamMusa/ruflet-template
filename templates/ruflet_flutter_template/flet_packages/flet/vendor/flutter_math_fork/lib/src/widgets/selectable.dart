...
import 'selection/platform_selection_style.dart';
import 'selection/selection_platform.dart';
...
class SelectableMath extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectionStyle = mathSelectionStyle(context);

    return RepaintBoundary(
      child: InternalSelectableMath(
        ast: ast!,
        autofocus: autofocus,
        cursorColor: cursorColor ?? selectionStyle.cursorColor,
        cursorOffset: selectionStyle.cursorOffset,
        cursorOpacityAnimates: selectionStyle.cursorOpacityAnimates,
        cursorRadius: cursorRadius ?? selectionStyle.cursorRadius,
        cursorWidth: cursorWidth,
        cursorHeight: cursorHeight,
        dragStartBehavior: dragStartBehavior,
        enableInteractiveSelection: enableInteractiveSelection,
        focusNode: focusNode,
        forcePressEnabled: selectionStyle.forcePressEnabled,
        options: options,
        paintCursorAboveText: selectionStyle.paintCursorAboveText,
        selectionColor: selectionStyle.selectionColor,
        showCursor: showCursor,
        textSelectionControls: textSelectionControls ?? selectionStyle.controls,
        toolbarOptions: toolbarOptions,
      ),
    );
  }
  ...
  static Widget defaultOnErrorFallback(FlutterMathException error) =>
      PlatformMathSelectionError(message: error.messageWithType);
}
...
class InternalSelectableMathState extends State<InternalSelectableMath>
  ...
  void onSelectionChanged(
    ...
    switch (MathSelectionPlatform.of(context)) {
