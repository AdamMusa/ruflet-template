...
class MarkdownBuilder implements md.NodeVisitor {
    ...
    if (isBlock) {
      ...
      if (builders.containsKey(tag)) {
        ...
        if (c is Text && c.textSpan is TextSpan) {
          ...
          textSpan = c.textSpan;
        } else if (c is MarkdownSelectableText) {
          textSpan = c.textSpan;
        }
        if (textSpan != null) {
  ...
  InlineSpan? _getInlineSpanFromText(Widget widget) => switch (widget) {
        ...
        MarkdownSelectableText() => widget.textSpan,
  ...
  Widget _buildRichText(TextSpan text, {TextAlign? textAlign, String? key}) {
    ...
    if (selectable) {
      return MarkdownSelectableText(
        textSpan: text,
        useCupertino: useCupertino,
        cupertinoContextMenuBuilder: cupertinoContextMenuBuilder,
