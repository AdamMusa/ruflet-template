...
import 'package:flet/src/utils/material_style_theme.dart';
import 'package:flet/src/utils/overlay_style.dart';
import 'package:flet/src/utils/style_theme.dart';
...
void main() {
  test('wire style parsers accept native semantic values without ThemeData',
      () {
    const style = FletStyleTheme(colors: {
